...
class WelcomePageViewController: UIViewController {
    ...
    fileprivate let items = [
        OnboardingItemInfo(informationImage: UIImage(named: "slim")!,
                           title: "Obesity index",
                           description: "Find out your obesity index. Our app precisely calculates index just for you!",
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "recipe")!,
                           title: "Test",
                           description: "Take a simple test and we will do our best to help you with diets.",
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "chat")!,
                           title: "Stats",
                           description: "Get statistics of your parameters during your diet.",
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "diet")!,
                           title: "Result",
                           description: "With our help you can rapidly lose weight. Get started right now!",
